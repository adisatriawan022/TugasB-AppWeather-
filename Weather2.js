...
import {AppRegistry, StyleSheet, View, Text, TextInput ,Button, Image} from 'react-native';

const windIcon = require('./img/wind.png');
const tempIcon = require('./img/temp.png');
const mainIcon = require('./img/main.png');
const main_descIcon = require('./img/main_desc.png');
...
getWeather= () => {
  ...
  '&appid=31258d4eac6a8f41101a6f7046d6dfd1=metric';
  fetch(url)
  ...
  render() {
    ...
    <View style={styles.weather}>
      ...
      <View style={styles.box4}>
        ...
        <View style={styles.button}>
          <View style={styles.iconContainer}>
            <Image source={main_descIcon} style={styles.icon} />
          </View>
    ...
    <View style={styles.box4}>
      ...
      <View style={styles.button}>
        ...
        <Text> Ground Level :{ this.state.forecast.ground_level} </Text>
      </View>
    </View>
  </View>
